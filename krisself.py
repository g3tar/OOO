...
║╠❂➣Getcover @
║╠❂➣nah (Mention)
║╠❂➣kamera on/off (Lurking)
║╠❂➣jepret/toong (Lurkers)
║╠❂➣Micadd @
║╠❂➣Micdel @
║╠❂➣Mimic on/off
║╠❂➣Miclist
...
wait = {
    ...
    'message':"""Thx for add""",
    "lang":"JP",
    "comment":"👉ąµţ๏ℓɨЌ€ By C-A_Bot😊\n\n☆º°˚˚✰ JCA-TEAM ✰º°˚˚☆（＾ω＾）\nąµţ๏ℓɨЌ€ by ulin ⭐👈 »»» http://line.me/ti/p/~z3ro_id «««",
    "commentOn":False,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
        ...
        if op.type == 26:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention"] == True:
                     ...
                     balas = ["Jangan tag aku ngpalahhhh!, ",cName + " kenapatag,kangen, ?",cName + " kalo kangen pc aja kampret,", "ada apa aihhh, ", cName + " Kamu kangen?","kangen bilang gak usah tag tag pant8, " + cName, "kenapa kenapaaa?, " + cName, "apasih aihhh?, " + cName + "?", "pulang san gih, trus mandi, " + cName + "?","iyah ada apa kampret, ?" + cName + "Tersangkut di pohon kamu -_-"]
...
#==============================================================================#
            ...
            elif "kamera off" == msg.text.lower():
                if msg.to not in wait2['readPoint']:
                 ...
                 if msg.toType == 2:
                    ...
                    if msg.to in wait2['readPoint']:
                        ...
                        kr.sendText(msg.to, "Ketik [kamera on] dulu, baru ketik [Toong]")


                    
            elif "jepret" == msg.text.lower():
                    if msg.to in wait2['readPoint']:
                        if wait2["ROM"][msg.to].items() == []:
...
#==============================================================================#
                ...
                try:
                    ...
                    for song in data:
                        ...
                        kr.sendText(msg.to, hasil)
                        kr.sendText(msg.to, "Tunggu Sebentar Sayang...")
